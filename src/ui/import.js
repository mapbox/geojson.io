...
module.exports = function(context) {
  return function(selection) {
    ...
    var wrap = selection.append("div").attr("class", "pad1");
    ...
    if (importSupport) {
      var import_landing = wrap.append("div").attr("class", "pad2 fillL");

      var message = import_landing.append("div").attr("class", "center");

      var button = message.append("button").on("click", function() {
      ...
      wrap
        ...
        .text(
          "Sorry, geojson.net supports importing GeoJSON, TopoJSON, KML, CSV, GPX, and OSM XML files, but " +
