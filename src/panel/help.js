...
<p>New here? <strong>geojson.net</strong> is a quick, simple tool for creating,
viewing, and sharing maps. geojson.net is named after <a href='http://geojson.org/' target='_blank'>GeoJSON</a>,
an open source data format, and it supports GeoJSON in all ways - but also
accepts KML, GPX, CSV, GTFS, TopoJSON, and other formats.</p>

<p>Need extra help or see a bug? <a target='_blank' href='https://github.com/tmcw/geojson.net/issues?state=open'>Open an issue
    on geojson.net's issue tracker.</a>
...
<ul>
    ...
    <li><strong>The data you create and modify in geojson.net</strong> doesn't
