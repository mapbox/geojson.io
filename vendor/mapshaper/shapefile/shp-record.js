...
export default function ShpRecordClass(type) {
  ...
  var baseProto = {
    ...
    readXY: function () {
      ...
      return this._data()
        .skipBytes(this._xypos())
        .readFloat64Array(this.pointCount * 2);
    },
  ...
  var mProto = {
    ...
    readMBounds: function () {
      return this.hasM()
        ? this._data().skipBytes(this._mpos()).readFloat64Array(2)
        : null;
    },
    ...
    readM: function () {
      return this.hasM()
        ? this._data()
            .skipBytes(this._mpos() + mzRangeBytes)
            .readFloat64Array(this.pointCount)
        : null;
    },
  ...
  var zProto = {
    ...
    readZ: function () {
      return this._data()
        .skipBytes(this._zpos() + mzRangeBytes)
        .readFloat64Array(this.pointCount);
    }
  };
